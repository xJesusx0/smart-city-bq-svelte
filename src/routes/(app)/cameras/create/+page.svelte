...
<svelte:head>
	<title>Crear semáforo - Smart City</title>
</svelte:head>
...
<div class="p-8">
	<div class="mb-8">
		<div class="flex items-center gap-2">
			...
			<h1 class="text-3xl font-bold tracking-tight">Crear nuevo semáforo</h1>
		</div>
		<p class="mt-2 text-muted-foreground">
			Completa los pasos para registrar un nuevo semáforo en el sistema.
		</p>
	</div>
